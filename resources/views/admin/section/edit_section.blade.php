				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
                            ...
                            {!! Form::open(['url' => '/update-section','class'=>'form-horizontal','id'=>'form_sample_1','method'=>'post','enctype'=>'multipart/form-data','name'=>'edit_department']) !!}
                             @csrf
										<div class="form-body">
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="section_name" placeholder="Enter Section name"
														class="form-control input-height" required="" value="{{$section_info->section_name }}" />
														<input type="hidden" name="section_id" 
														class="form-control input-height"  value="{{$section_info->section_id }}" />
												</div>
											</div>

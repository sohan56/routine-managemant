				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
                            ...
                            {!! Form::open(['url' => '/save-slider','class'=>'form-horizontal','id'=>'form_sample_1','method'=>'post','enctype'=>'multipart/form-data']) !!}
                             @csrf
										<div class="form-body">
											...
											<div class="form-group row">
												...
												<div class="compose-editor">
													<input type="file" class="default" multiple required="" name="slider_img">
												</div>
											</div>

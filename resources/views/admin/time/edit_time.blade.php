				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Edit time</div>
							</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
                            ...
                            {!! Form::open(['url' => '/update-time','class'=>'form-horizontal','id'=>'form_sample_1','method'=>'post','enctype'=>'multipart/form-data','name'=>'edit_department']) !!}
                             @csrf
										<div class="form-body">
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="time" placeholder="Enter time "
														class="form-control input-height" required="" value="{{$time_info->time }}" />
														<input type="hidden" name="time_id" 
														class="form-control input-height"  value="{{$time_info->time_id }}" />
												</div>
											</div>

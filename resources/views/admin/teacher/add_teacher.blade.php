				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
                            ...
                            {!! Form::open(['url' => '/save-teacher','class'=>'form-horizontal','id'=>'form_sample_1','method'=>'post','enctype'=>'multipart/form-data']) !!}
                             @csrf
										<div class="form-body">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="password" name="teacher_password" placeholder="Enter teacher password"
														class="form-control input-height" required="" />
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="file" name="teacher_img" placeholder="Enter teacher Image"
														class="form-control input-height" required="" />
												</div>
											</div>
											<div class="form-group row">

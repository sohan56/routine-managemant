					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown dropdown-user">
							<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
								...
								<img alt="" class="img-circle " src="{{asset(session('teacher_img'))}}" />
								<span class="username username-hide-on-mobile"> <?php echo Session::get('teacher_name');?> </span>
					...
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="sidebar-user-panel">
								<div class="user-panel">
									<div class="pull-left image">
										<img src="{{asset(session('teacher_img'))}}" class="img-circle user-img-circle"
											alt="User Image" />
									</div>
									<div class="pull-left info">
										<p><?php echo Session::get('teacher_name');?></p>
							...
							<li class="nav-item start active open">
								<a href="{{URL::to('/teacher-deshboard')}}" class="nav-link nav-toggle">
							...
							<li class="nav-item">
								...
								<ul class="sub-menu">
									...
									<li class="nav-item">
										<a href="{{URL::to('/teacher-make-routine')}}"class="nav-link "> <span class="title">Make Routine</span>
									...
									<li class="nav-item">
										<a href="{{ url('teacher-view-routine/routine') }}" class="nav-link "> <span class="title">View Routine</span>
